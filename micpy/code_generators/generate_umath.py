...
'log1p':
    Ufunc(1, 1, None,
          ...
          TD(inexactvec),
          TD(inexactnoevec, f='log1p'),
          ),
'logb':
   Ufunc(1, 1, None,
          '',
          None,
          TD('e', f='logb', astype={'e':'f'}),
          TD(inexactvec),
          TD('g', f='logb'),
          ),
'sqrt':
