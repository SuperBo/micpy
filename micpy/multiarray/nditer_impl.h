 ...
 */
#ifndef MPY_ITERATOR_IMPLEMENTATION_CODE
#error "This header is intended for use ONLY by iterator implementation code."
#endif

#ifndef _MPY_PRIVATE__NDITER_IMPL_H_
#define _MPY_PRIVATE__NDITER_IMPL_H_
...
#define NIT_NOP(iter) \
        ((iter)->nop)
#define NIT_DEVICE(iter) \
        ((iter)->device)
#define NIT_OFFITER(iter) \
        ((iter)->offptr)
...
#define NIT_OPERANDS(iter) ((PyMicArrayObject **)( \
...
NPY_NO_EXPORT void
mpyiter_update_offiter(MpyIter *iter);
