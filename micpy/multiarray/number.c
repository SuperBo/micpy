 ...
 */
static PyObject *
array_inplace_add(PyMicArrayObject *m1, PyObject *m2);
static PyObject *
array_inplace_subtract(PyMicArrayObject *m1, PyObject *m2);
static PyObject *
array_inplace_multiply(PyMicArrayObject *m1, PyObject *m2);
#if !defined(NPY_PY3K)
static PyObject *
array_inplace_divide(PyMicArrayObject *m1, PyObject *m2);
#endif
static PyObject *
array_inplace_true_divide(PyMicArrayObject *m1, PyObject *m2);
static PyObject *
array_inplace_floor_divide(PyMicArrayObject *m1, PyObject *m2);
static PyObject *
array_inplace_bitwise_and(PyMicArrayObject *m1, PyObject *m2);
static PyObject *
array_inplace_bitwise_or(PyMicArrayObject *m1, PyObject *m2);
static PyObject *
array_inplace_bitwise_xor(PyMicArrayObject *m1, PyObject *m2);
static PyObject *
array_inplace_left_shift(PyMicArrayObject *m1, PyObject *m2);
static PyObject *
array_inplace_right_shift(PyMicArrayObject *m1, PyObject *m2);
static PyObject *
array_inplace_remainder(PyMicArrayObject *m1, PyObject *m2);
static PyObject *
array_inplace_power(PyMicArrayObject *a1, PyObject *o2, PyObject *NPY_UNUSED(modulo));
 ...
 */
NPY_NO_EXPORT int
PyMicArray_SetNumericOps(PyObject *dict)
{
    PyObject *temp = NULL;
    SET(add);
    SET(subtract);
...
static PyObject *
_get_keywords(int rtype, PyMicArrayObject *out)
{
    PyObject *kwds = NULL;
...
NPY_NO_EXPORT PyObject *
PyMicArray_GenericReduceFunction(PyMicArrayObject *m1, PyObject *op, int axis,
...
NPY_NO_EXPORT PyObject *
PyMicArray_GenericAccumulateFunction(PyMicArrayObject *m1, PyObject *op, int axis,
                                  int rtype, PyMicArrayObject *out)
{
    PyObject *args, *ret = NULL, *meth;
    PyObject *kwds;
...
NPY_NO_EXPORT PyObject *
PyArray_GenericBinaryFunction(PyMicArrayObject *m1, PyObject *m2, PyObject *op)
{
    /*
...
NPY_NO_EXPORT PyObject *
PyArray_GenericUnaryFunction(PyMicArrayObject *m1, PyObject *op)
{
    if (op == NULL) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
...
static PyObject *
PyArray_GenericInplaceBinaryFunction(PyMicArrayObject *m1,
...
static PyObject *
PyArray_GenericInplaceUnaryFunction(PyMicArrayObject *m1, PyObject *op)
{
    if (op == NULL) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
...
static PyObject *
array_add(PyMicArrayObject *m1, PyObject *m2)
{
    PyObject *res;
...
static PyObject *
array_subtract(PyMicArrayObject *m1, PyObject *m2)
{
    PyObject *res;
...
static PyObject *
array_multiply(PyMicArrayObject *m1, PyObject *m2)
{
    PyObject *res;
...
#if !defined(NPY_PY3K)
static PyObject *
array_divide(PyMicArrayObject *m1, PyObject *m2)
{
    PyObject *res;
...
static PyObject *
array_remainder(PyMicArrayObject *m1, PyObject *m2)
{
...
static PyObject *
array_divmod(PyMicArrayObject *m1, PyObject *m2)
{
...
static PyObject *
array_matrix_multiply(PyMicArrayObject *m1, PyObject *m2)
{
    //TODO: remove this comment after matmul implemented
    static PyObject *matmul = NULL;

    npy_cache_import("micpy.multiarray", "matmul", &matmul);
    if (matmul == NULL) {
        return NULL;
    }
...
static PyObject *
array_inplace_matrix_multiply(PyMicArrayObject *m1, PyObject *m2)
{
 ...
 */
static int
fast_scalar_power(PyMicArrayObject *a1, PyObject *o2, int inplace,
                  PyObject **value)
{
    double exponent;
    NPY_SCALARKIND kind;   /* NPY_NOSCALAR is not scalar */

    if (PyMicArray_Check(a1) && ((kind=is_scalar_with_conversion(o2, &exponent))>0)) {
        PyObject *fastop = NULL;
        if (PyMicArray_ISFLOAT(a1) || PyMicArray_ISCOMPLEX(a1)) {
            if (exponent == 1.0) {
         ...
         */
            ...
            if (inplace) {
                *value = PyArray_GenericInplaceUnaryFunction(a1, fastop);
                ...
                /*TODO: test this case */
                if (kind == NPY_FLOAT_SCALAR && PyMicArray_ISINTEGER(a1)) {
                    PyArray_Descr *dtype = PyArray_DescrFromType(NPY_DOUBLE);
                    a1 = (PyMicArrayObject *)PyMicArray_CastToType(a1, dtype,
                            PyMicArray_ISFORTRAN(a1));
                    if (a1 != NULL) {
...
static PyObject *
array_power(PyMicArrayObject *a1, PyObject *o2, PyObject *modulo)
{
    PyObject *value = NULL;
...
static PyObject *
array_negative(PyMicArrayObject *m1)
{
...
static PyObject *
array_absolute(PyMicArrayObject *m1)
{
    if (can_elide_temp_unary(m1) && !PyMicArray_ISCOMPLEX(m1)) {
...
static PyObject *
array_invert(PyMicArrayObject *m1)
{
    if (can_elide_temp_unary(m1)) {
...
static PyObject *
array_left_shift(PyMicArrayObject *m1, PyObject *m2)
{
    PyObject *res;
...
static PyObject *
array_right_shift(PyMicArrayObject *m1, PyObject *m2)
{
    PyObject *res;
...
static PyObject *
array_bitwise_and(PyMicArrayObject *m1, PyObject *m2)
{
    PyObject *res;
...
static PyObject *
array_bitwise_or(PyMicArrayObject *m1, PyObject *m2)
{
    PyObject *res;
...
static PyObject *
array_bitwise_xor(PyMicArrayObject *m1, PyObject *m2)
{
    PyObject *res;
...
static PyObject *
array_floor_divide(PyMicArrayObject *m1, PyObject *m2)
{
    PyObject *res;
...
static PyObject *
array_true_divide(PyMicArrayObject *m1, PyObject *m2)
{
    PyObject *res;

    BINOP_GIVE_UP_IF_NEEDED(m1, m2, nb_true_divide, array_true_divide);
    if (PyMicArray_CheckExact(m1) &&
            (PyMicArray_ISFLOAT(m1) || PyMicArray_ISCOMPLEX(m1)) &&
...
static int
_array_nonzero(PyMicArrayObject *mp)
{
    npy_intp n;
    PyMicArray_NonzeroFunc *nonzero;

    n = PyMicArray_SIZE(mp);
    if (n == 1) {
        int res;
        ...
        nonzero = PyMicArray_GetArrFuncs(PyMicArray_DESCR(mp)->type_num)->nonzero;
        if (nonzero == NULL) {
            return -1;
        }
        res = nonzero(PyMicArray_DATA(mp), mp);
...
NPY_NO_EXPORT PyObject *
array_int(PyMicArrayObject *v)
{
    PyObject *pv, *pv2;
    PyMicArray_GetItemFunc *fget;
    if (PyMicArray_SIZE(v) != 1) {
        PyErr_SetString(PyExc_TypeError, "only length-1 arrays can be"\
                        " converted to Python scalars");
        return NULL;
    }
    fget = PyMicArray_GetArrFuncs(PyMicArray_DESCR(v)->type_num)->getitem;
    if (fget == NULL) {
        return NULL;
    }
    pv = fget(PyMicArray_DATA(v), v);
    if (pv == NULL) {
        return NULL;
    }
     ...
     */
    if (PyMicArray_Check(pv) &&
                PyDataType_REFCHK(PyMicArray_DESCR((PyMicArrayObject *)pv))) {
        PyErr_SetString(PyExc_TypeError,
...
static PyObject *
array_float(PyMicArrayObject *v)
{
    PyObject *pv, *pv2;
    PyMicArray_GetItemFunc *fget;
    if (PyMicArray_SIZE(v) != 1) {
    ...
    //pv = PyArray_DESCR(v)->f->getitem(PyMicArray_DATA(v), v);
    fget = PyMicArray_GetArrFuncs(PyMicArray_DESCR(v)->type_num)->getitem;
    if (fget == NULL) {
        return NULL;
    }
...
array_long(PyMicArrayObject *v)
{
    ...
    //pv = PyMicArray_DESCR(v)->f->getitem(PyArray_DATA(v), v);
    fget = PyMicArray_GetArrFuncs(PyMicArray_DESCR(v)->type_num)->getitem;
    if (fget == NULL) {
        return NULL;
    }
     ...
     */
    if (PyMicArray_Check(pv) &&
                    PyDataType_REFCHK(PyMicArray_DESCR((PyArrayObject *)pv))) {
        PyErr_SetString(PyExc_TypeError,
                "object array may be self-referencing");
        Py_DECREF(pv);
        return NULL;
...
static PyObject *
_array_copy_nice(PyMicArrayObject *self)
{
    return PyMicArray_Return((PyMicArrayObject *) PyMicArray_Copy(self));
}

static PyObject *
array_index(PyMicArrayObject *v)
{
    PyMicArray_GetItemFunc *fget;
    if (!PyMicArray_ISINTEGER(v) || PyMicArray_NDIM(v) != 0) {
        PyErr_SetString(PyExc_TypeError,
    ...
    return fget(PyMicArray_DATA(v), v);
}
